...
plexStatus=`curl https://ct-plex.emeralddesign.com:32400/web/index.html -s -k | grep plex-logo | wc -l`
        ...
        then
                if [ "$logData" = "" ]
                        then
                                ...
                                curl -X POST -H 'Content-type: application/json' --data '{"text":"[PLEX FAILOVER] Plex Server Failover Event!"}' https://hooks.slack.com/services/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
                fi
fi
        ...
        then
                if [ "$logData" = "Secondary Restarted" ]
                        then
                                ...
                                curl -X POST -H 'Content-type: application/json' --data '{"text":"[PLEX FAILOVER OK] Plex Server Primary OK!"}' https://hooks.slack.com/services/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
